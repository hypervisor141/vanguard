...
public final class VLListInt extends VLListArrayBacked<int[]> {

    public VLListInt(int capacity, int resizeoverhead){
        super(0, resizeoverhead);
        backend = new int[capacity];
    }

    public VLListInt(int[] data, int resizeoverhead){
